            ...
            for undetermined in undetermineds:
                if twin[0] in values[undetermined] and twin[1] in values[undetermined]:
                    if len(values[undetermined]) == 2: continue
                        ...
                        values[undetermined].replace(twin[0], '')
                        values[undetermined].replace(twin[1], '')
                if twin[0] in values[undetermined]:
                    assign_value(values,undetermined,values[undetermined].replace(twin[0], ''))
                    # print(twin[0])
                    # print(values[undetermined])
                if twin[1] in values[undetermined]:
                    assign_value(values,undetermined,values[undetermined].replace(twin[1], ''))
    return values
