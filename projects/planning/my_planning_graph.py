...
class PlanningGraph():
    ...
    def add_action_level(self, level):
        ...
        for action in self.all_actions:
            ...
            if node_a.prenodes & self.s_levels[level] == node_a.prenodes:
    ...
    def add_literal_level(self, level):
        ...
        for a_node in self.a_levels[level-1]:
            for s_node in a_node.effnodes:
                ...
                nodes_hash.add(s_node)
        self.s_levels.append(nodes_hash)
    ...
    def serialize_actions(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        if node_a1.is_persistent or node_a2.is_persistent:
            return False
        return True
        return self.serial and not (node_a1.is_persistent or node_a2.is_persistent)
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        return set(node_a1.action.effect_add) & set(node_a2.action.effect_rem) or set(node_a1.action.effect_rem) & set(node_a2.action.effect_add)
    ...
    def competing_needs_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        for n1 in node_a1.parents:
            for n2 in node_a2.parents:
                if n1.is_mutex(n2) or n2.is_mutex(n1):
                    return True
        return False
